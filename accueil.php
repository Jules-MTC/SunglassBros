...
require_once './produit/recup_produit.php';
require './produit/ajout_panier.php';
...
<head>
    ...
    <title>Boutique - The Sunglass Bros</title>
    <!-- Favicon-->
        ...
        <div class="container px-4 px-lg-5">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="./produit/all_produit.php">Tout les produits</a></li>
                            <li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item" href="./produit/ajout_produit.php">Ajouter un produit</a></li>
                            <li><a class="dropdown-item" href="./produit/modif_produit.php">Modifier un produit</a></li>
                            <li><a class="dropdown-item" href="./produit/supp_produit.php">Supprimer un produit</a></li>
                        <?php }
                        ?>
                        </ul>
                    </li>
                ...
                <form class="d-flex">
                    <button class="btn btn-outline-dark" type="button">
                        ...
                        <li class="nav-item dropdown">
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown" <?php if (!empty($_SESSION['panier'])) {
                                                                                        ...
                                                                                        ?> <li><a class="dropdown-item" href="./produit/affiche_produit.php?id=<?php echo $_SESSION['panier'][$key]['id_produit']; ?>"><img class="card-img-top" src="./produit/image/<?php echo $_SESSION['panier'][$key]['image']; ?>" alt="<?php echo $_SESSION['panier'][$key]['image']; ?>" /></a>
                        </li>
                    ...
                    <li><a class="dropdown-item" href="./produit/supp_panier.php?loc=accueil.php">Vider panier</a></li>
                    <li><a class="dropdown-item" href="./produit/affiche_panier.php">Passer commande</a></li>
                <?php
                                                                                        } else {
    ...
    <header class="bg-dark py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="text-center text-white">
                <h1 class="display-4 fw-bolder">Les lunettes ultra stylé <img src="./style/emoji_l_soleil.png"></h1> <!-- ajouter un smiley ? -->
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <a class="no-style" href="./produit/affiche_produit.php?id=<?php echo $$row['id_produit']; ?>">
                                <!-- Product image-->
                                <img class="card-img-top" src="./produit/image/<?php echo $$row['image_produit']; ?>" alt="<?php echo $$row['image_produit']; ?>" />
                                <!-- Product details-->
                                ...
                                <center>
                                    <?php if ($$row['quantite'] != 0) {
                                    ?>
                                        <form method="post" name="ajout_panier" action="accueil.php">
                            ...
                            <?php } ?>
                            <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="./produit/affiche_produit?id=<?php echo $$row['id_produit']; ?>.php">Afficher</a></div>
                            </center>
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <?php if ($user['droits'] == 'admin') {
                                ?>
                                    <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="./produit/modif_produit?id=<?php echo $$row['id_produit']; ?>.php">Modifier</a></div>
                                <?php } ?>
                            </div>
                        </div>
                        </a>
